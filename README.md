...
# Usage
The principle is pretty easy. You load the provided 'iso-scan-13.6.0.gz' along with the main 'initrd.gz' of the installation media via grub loopback module. This adds necessary functionality for installing the Debian 13.6 vis debian installer. If you are using 'https://github.com/Mexit/MultiOS-USB', it is just a few steps:
